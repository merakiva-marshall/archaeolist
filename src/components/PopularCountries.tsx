...
const countries = [
    ...
    },
    {
        ...
        description: (
            <>
                Everyone knows <Link href="/sites/peru/machu-picchu" className="text-blue-600 hover:underline">Machu Picchu</Link>, but Peru&apos;s archaeological story goes back thousands of years before the Incas showed up. The <Link href="/sites/peru/nazca-lines" className="text-blue-600 hover:underline">Nazca Lines</Link>—huge geoglyphs carved into the desert that you can only really see from the air—are still genuinely mysterious. <Link href="/sites/peru/chan-chan" className="text-blue-600 hover:underline">Chan Chan</Link>, near the coast, was one of the largest adobe cities ever built. And the <Link href="/sites/peru/sacred-valley" className="text-blue-600 hover:underline">Sacred Valley</Link> is packed with Inca sites that get a fraction of the crowds Machu Picchu does. The geography helps too: you&apos;ve got coastal desert, the Andes at 15,000+ feet, and the edge of the Amazon all in one country, each region with its own history of settlement.
            </>
        )
    },
    {
