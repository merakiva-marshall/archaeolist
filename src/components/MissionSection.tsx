...
export default function MissionSection() {
    return (
        <section className="py-20 bg-surface border-t border-outline-variant relative z-10">
            <div className="max-w-7xl mx-auto px-8">

                {/* Intro Blurb */}
                <div className="max-w-3xl mx-auto text-center mb-16">
                    <span className="text-xs font-headline font-bold uppercase tracking-[0.2em] text-primary-brand">Our Mission</span>
                    <h2 className="text-3xl font-headline font-black text-primary-brand tracking-tight mt-1 mb-6">Why We Built This</h2>
                    <p className="text-base font-body text-on-surface leading-loose">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    {/* Pillar 1 */}
                    <div>
                        <div className="w-12 h-12 bg-surface-container rounded-xl flex items-center justify-center mb-6 text-primary-brand">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                            </svg>
                        </div>
                        <h3 className="text-lg font-headline font-black text-primary-brand tracking-tight mb-4">Making It Findable</h3>
                        <p className="text-sm font-body text-on-surface leading-loose">
                    ...
                    <div>
                        ...
                        <h3 className="text-lg font-headline font-black text-primary-brand tracking-tight mb-4">Built to Grow</h3>
                        <p className="text-sm font-body text-on-surface leading-loose">
                    ...
                    <div>
                        ...
                        <h3 className="text-lg font-headline font-black text-primary-brand tracking-tight mb-4">The Real Story Is Better</h3>
                        <p className="text-sm font-body text-on-surface leading-loose">
