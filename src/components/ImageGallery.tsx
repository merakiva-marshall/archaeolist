...
export default function ImageGallery({ site, variant = 'default' }: ImageGalleryProps) {
  ...
  // Redesign variant - 3-column grid with +N More overlay
  if (variant === 'redesign') {
            ...
            >
              ...
              {index === 2 && remainingCount > 0 && (
                <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                  <span className="text-white text-sm font-headline font-bold">
                    +{remainingCount} More
                  </span>
                </div>
              )}
